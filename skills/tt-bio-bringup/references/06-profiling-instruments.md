...
- **A `ttnn` op call is an asynchronous enqueue.** `ttnn.add(a, b)` returns as soon as the command
  ...
  matmul: 0.019 ms/iter unsynced vs 0.145 ms/iter synced, a **7.68x** under-report, and the factor
